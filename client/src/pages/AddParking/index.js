...
const steps = ["Parking Address","Slots Details", "Availability", "Review Your Details"];
...
class AddParking extends Component {
    ...
    switch (step) {
      ...
      case 1:
        return (
          ...
          <SlotForm {...this.state} handleFormSubmit={this.handleFormSubmit} />
        );
      case 2:
        return (
           <PaymentForm
  ...
  handleClose = () => {
    this.setState(
      ...
      () => {
        this.props.history.push("/searchresult1");
      }
    );
  };
      ...
      <div>
        ...
        <React.Fragment>
          ...
          <main className={classes.layout}>
            ...
            >
              <DialogTitle id="form-dialog-title">Summary of Details</DialogTitle>
              <DialogContent>
                {" "}
                <Typography>Parking Added successfully!</Typography>
              </DialogContent>
...
export default withStyles(styles)(AddParking);
